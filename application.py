...
def index():
    ...
    return render_template('index.html', companies=companies, car_model=car_model, car_age=car_age, fuel_types=fuel_type, transmission=transmission, ownership=ownership,kms_driven=kms_driven)
